...
namespace EpubNet.Entities
{
    ...
    {
        public static List<string> GetChaptersAsPlainText(this EpubBook book) => book.Chapters.Select(x => x.ToPlainText()).ToList();

        public static string GetPlainText(this EpubBook book) => book.ToPlainText();
    }
}